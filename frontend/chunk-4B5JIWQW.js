...
// src/app/components/port-agent-form/port-agent-form.model.ts
var SubService = class {
  name = null;
  purpose = null;
  basic_value = null;
  unique_key = null;
...
var Item = class {
  ...
  constructor(data) {
    if (data) {
      Object.assign(this, data);
      if (data.subService) {
        this.subService = data.subService.map((s) => new SubService(s));
      }
    }
  }
};
...
var PA_Rules = class {
  ...
  constructor(data) {
    if (data) {
      Object.assign(this, data);
      if (data.items) {
        this.items = data.items.map((i) => new PA_Item(i));
      }
    }
  }
};
...
var fields = [
  { name: "Client", value: "client_id", type: "select", data_type: "number", options: [], PAForm: false, readOnly: false, createPdaForm: true },
  { name: "Port Agent", value: "portagent_id", type: "select", data_type: "number", options: [], PAForm: false, readOnly: false, createPdaForm: true },
  { name: "Country", value: "country_id", type: "select", data_type: "text", options: [], PAForm: true, readOnly: false, createPdaForm: true },
  { name: "Port", value: "port_id", type: "select", data_type: "text", options: [], PAForm: true, readOnly: false, createPdaForm: true },
  { name: "IMO Number", value: "imo_number", type: "input", data_type: "text", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "Vessel", value: "vessel", type: "input", data_type: "text", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "NRT", value: "nrt", type: "input", data_type: "number", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "GRT", value: "grt", type: "input", data_type: "number", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "RGRT", value: "rgrt", type: "input", data_type: "number", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "LOA", value: "loa", type: "input", data_type: "number", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "Beam", value: "beam", type: "input", data_type: "number", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "Depth", value: "depth", type: "input", data_type: "number", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "Dead Weight", value: "dwt", type: "input", data_type: "number", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "Cargo", value: "cargo_id", type: "select", data_type: "number", options: [], PAForm: true, readOnly: false, createPdaForm: true },
  { name: "Purpose", value: "purpose_id", type: "select", data_type: "text", options: [], PAForm: true, readOnly: false, createPdaForm: true },
  { name: "ETA", value: "eta", type: "date", data_type: "date", options: null, PAForm: true, readOnly: false, createPdaForm: true },
  { name: "ETD", value: "etd", type: "date", data_type: "date", options: null, PAForm: true, readOnly: false, createPdaForm: true },
  { name: "Vessel Stay", value: "vessel_stay", type: "input", data_type: "text", options: null, PAForm: true, readOnly: false, createPdaForm: true },
  // currency conversion changes
  // { name: 'FromCurrency', value: 'pda_currency_from', type: 'select', data_type: 'input', options: [], PAForm: true, readOnly: false },
  { name: "FromCurrency", value: "pda_currency_from", type: "input", data_type: "input", options: [], PAForm: true, readOnly: true, createPdaForm: true },
  { name: "ToCurrency", value: "pda_currency_to", type: "select", data_type: "input", options: [], PAForm: true, readOnly: false, createPdaForm: true },
  { name: "ROE", value: "pda_roe", type: "input", data_type: "number", options: null, PAForm: true, readOnly: false, createPdaForm: true },
  { name: "Voyage", value: "voyage", type: "input", data_type: "text", options: null, PAForm: true, readOnly: false, createPdaForm: true },
  { name: "Invoice Ref No", value: "invoice_ref_no", type: "input", data_type: "text", options: null, PAForm: true, readOnly: false, createPdaForm: true }
];
var fdaFields = [
  { name: "Client", value: "client_id", type: "select", data_type: "number", options: [], PAForm: false, readOnly: false, createPdaForm: true },
  { name: "Port Agent", value: "portagent_id", type: "select", data_type: "number", options: [], PAForm: false, readOnly: false, createPdaForm: true },
  { name: "Country", value: "country_id", type: "select", data_type: "text", options: [], PAForm: true, readOnly: false, createPdaForm: true },
  { name: "Port", value: "port_id", type: "select", data_type: "text", options: [], PAForm: true, readOnly: false, createPdaForm: true },
  { name: "IMO Number", value: "imo_number", type: "input", data_type: "number", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "Vessel", value: "vessel", type: "input", data_type: "text", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "NRT", value: "nrt", type: "input", data_type: "number", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "GRT", value: "grt", type: "input", data_type: "number", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  { name: "RGRT", value: "rgrt", type: "input", data_type: "number", options: null, PAForm: true, readOnly: true, createPdaForm: true },
  ...
  { name: "Vessel Stay", value: "vessel_stay", type: "input", data_type: "text", options: null, PAForm: true, readOnly: false, createPdaForm: true },
  // currency conversion changes
  // { name: 'FromCurrency', value: 'fda_currency_from', type: 'select', data_type: 'input', options: [], PAForm: true, readOnly: false },
  { name: "FromCurrency", value: "fda_currency_from", type: "input", data_type: "text", options: [], PAForm: true, readOnly: true, createPdaForm: true },
  { name: "ToCurrency", value: "fda_currency_to", type: "select", data_type: "input", options: [], PAForm: true, readOnly: false, createPdaForm: true },
  { name: "ROE", value: "fda_roe", type: "input", data_type: "number", options: null, PAForm: true, readOnly: false, createPdaForm: true },
  { name: "Voyage", value: "voyage", type: "input", data_type: "text", options: null, PAForm: true, readOnly: false, createPdaForm: true },
  { name: "Invoice Ref No", value: "invoice_ref_no", type: "input", data_type: "text", options: null, PAForm: true, readOnly: false, createPdaForm: true }
];
var convertVesselStayToMinutes = (vesselStay) => {
  if (!vesselStay)
    return 0;
  const dayMatch = vesselStay.match(/(\d+)\s?(Days?|D)/i);
  const hourMatch = vesselStay.match(/(\d+)\s?(H|Hr)/i);
  const days = dayMatch ? parseInt(dayMatch[1], 10) : 0;
  const hours = hourMatch ? parseInt(hourMatch[1], 10) : 0;
  return days * 24 * 60 + hours * 60;
};
var invoiceReferenceValidation = (control) => {
  const value = control.value || "";
  if (!value.trim()) {
    return { required: true };
  }
  const patternValid = /^[A-Za-z0-9-_]{3,20}$/.test(value);
  return !patternValid ? { invalidData: true } : null;
};
...
// src/app/pages/pda/pda.model.ts
var calculateVesselStay = (eta, etd) => {
  if (!eta || !etd)
    return null;
  let etaDate = new Date(eta);
  let etdDate = new Date(etd);
  if (etdDate.getTime() < etaDate.getTime()) {
    return "eta greater than etd";
  }
  const totalMilliseconds = etdDate.getTime() - etaDate.getTime();
  const totalDays = totalMilliseconds / (1e3 * 3600 * 24);
  const days = Math.floor(totalDays);
  return `${days + 1}D`;
};
var mergeResponseVesselIntoList = (vessels, vesselDetails) => {
  const list = Array.isArray(vessels) ? [...vessels] : [];
  if (!vesselDetails?.vessel_id) {
    return list;
  }
  const exists = list.some((v) => v.vessel_id === vesselDetails.vessel_id);
  if (exists) {
    return list;
  }
  const responseVessel = {
    vessel_id: vesselDetails.vessel_id,
    name: vesselDetails?.vessel_name || vesselDetails?.vessel || "",
    imo_number: vesselDetails?.imo_number || vesselDetails?.vessel_imo || "",
    grt: vesselDetails?.grt?.current || vesselDetails?.grt || "",
    rgrt: vesselDetails?.rgrt?.current || vesselDetails?.rgrt || "",
    nrt: vesselDetails?.nrt?.current || vesselDetails?.nrt || "",
    loa: vesselDetails?.loa?.current || vesselDetails?.loa || "",
    beam: vesselDetails?.beam?.current || vesselDetails?.beam || "",
    depth: vesselDetails?.depth?.current || vesselDetails?.depth || "",
    dwt: vesselDetails?.dwt?.current || vesselDetails?.dwt || "",
    type: vesselDetails?.type?.current || vesselDetails?.type || "",
    additional_fields: vesselDetails?.additional_fields || []
  };
  return [responseVessel, ...list];
};
var autoCompleteFilter = (field, formGroup, filteredOptions) => {
  formGroup.get(field.value)?.valueChanges.subscribe((value) => {
    ...
    filteredOptions[field.value] = filtered;
  });
};
var displayFn = (field, value) => {
  if (value == null || value === "")
    return "";
  const keyBase = field?.name?.trim().toLowerCase().replace(/\s+/g, "");
  const idKey = `${keyBase}_id`;
  const options = field?.options || [];
  if (field?.name === "Cargo") {
    if (typeof value === "object") {
      return value?.type ?? value?.name ?? "";
    }
    const cargo = options.find((c) => c?.cargo_id === value || c?.id === value);
    return cargo?.type ?? cargo?.name ?? "";
  }
  ...
  if (typeof value === "object") {
    if (value?.name)
      return value.name;
    if (value?.[idKey] != null) {
      const match2 = options.find((opt) => opt?.[idKey] === value[idKey]);
      return match2?.name ?? "";
    }
    return "";
  }
  const match = options.find((opt) => opt?.[idKey] === value || opt?.value === value || opt?.name === value);
  return match?.name ?? (typeof value === "string" ? value : "");
};
var getOptionValuefortheFields = (field, opt, addedFields) => {
  const matchedFields = addedFields.filter((addedField) => !fields.some((f) => f.name?.trim() === addedField.fieldName?.trim()));
  if (field.name === "ToCurrency" || field.name === "FromCurrency") {
    return opt;
  } else if (matchedFields.some((f) => f.fieldName === field.name)) {
    return opt.name;
  } else {
...
var addAdditionalFieldsToFieldsArray = (port_id, portList, fields2, portAgentForm, addedFields, filteredOptions, fb) => {
  const selectedPort = portList.find((port) => port.port_id === port_id);
  if (selectedPort) {
    const addVslFields = selectedPort.vessel_fields.filter((vf) => !!vf.field_name).map((vf) => {
      let type = "input";
      let options = [];
      const [splitType, splitData] = vf.data_type?.split(":") || [];
      const controlName = vf.field_name.trim();
      if (splitType === "select") {
        type = "select";
        options = splitData.split(",").map((option) => ({
          name: option.trim(),
          value: option.trim()
        }));
      }
      return {
        name: vf.field_name,
        value: controlName,
        type: splitType === "date" ? "date" : type,
        data_type: splitType === "select" ? "string" : splitType,
        options,
        is_mandatory: vf.is_mandatory ?? "N"
      };
    });
    addVslFields.forEach((field) => {
      const alreadyExists = fields2.some((f) => f.value === field.value);
      const alreadyInAddedFields = addedFields.some((af) => af.controlName === field.value);
      const isRequired = field.is_mandatory === "Y";
      if (field.type === "select") {
        filteredOptions[field.value] = field?.options || [];
      }
      if (!alreadyExists) {
        fields2.push(field);
        portAgentForm.addControl(field.value, fb.control(null, isRequired ? Validators.required : []));
      }
      if (!alreadyInAddedFields) {
        addedFields.push({
          fieldName: field.name,
          controlName: field.value,
          is_mandatory: field.is_mandatory ?? "N",
          data_type: field.data_type ?? "string"
        });
      }
      if (alreadyExists) {
        const existingControl = portAgentForm.get(field.value);
        if (existingControl) {
          if (existingControl.value === null || existingControl.value === void 0) {
            existingControl.setValue("");
          }
          existingControl.setValidators(isRequired ? Validators.required : []);
...
var validateVesselStay = (field, formGroup) => {
  const vesselStayControl = formGroup.get(field.value);
  const vesselStayValue = vesselStayControl?.value?.trim();
  const formatRegex = /^(\d+)\s?(Days?|D)$|^(\d+)\s?(H|Hr)$|^(\d+)\s?(Days?|D)\s*(\d+)\s?(H|Hr)$|^(\d+)\s?(H|Hr)\s*(\d+)\s?(Days?|D)$/i;
  const match = vesselStayValue.match(formatRegex);
  if (!match) {
    vesselStayControl?.setErrors({ invalidFormat: true });
    vesselStayControl?.markAsTouched();
    return;
  }
  let days = 0;
  let hours = 0;
  ...
  if (match[3] || match[4]) {
    hours = parseInt(match[3] || match[4], 10);
  }
  if (match[5] || match[6]) {
    days = parseInt(match[5] || match[6], 10);
  }
  if (match[7] || match[8]) {
    hours = parseInt(match[7] || match[8], 10);
  }
  if (days < 0 || hours < 0) {
    vesselStayControl?.setErrors({ invalidNumber: true });
    vesselStayControl?.markAsTouched();
    return;
  }
  vesselStayControl?.setErrors(null);
  vesselStayControl?.markAsTouched();
};
var convertMinutesToDaysOrHours = (minutes) => {
...
var getCompanyIdByName = (companyList) => {
  return companyList.find((company) => company.company_name?.includes("Meraki"))?.company_id || null;
};
var formatToLocalISOString = (dateInput) => {
...
var clearVesselDetails = (formGroup) => {
...
var displayClientComment = (clientRemark) => {
  const parts = clientRemark?.split(" -> ");
  const filteredParts = parts?.filter((item) => item !== "null");
  return filteredParts?.join(" -> ");
};
var replaceMovementPart = (movement, partIndex, replacementValue) => {
  return movement?.split(":").map((part, index) => {
    return index === partIndex ? replacementValue : part;
  }).join(":");
};
var getPurposeName = (purposeList, purposeId) => {
  const purpose = purposeList.find((purpose2) => purpose2.purpose_id === purposeId)?.name;
  return purpose || "";
};
var filterServicesOnPurpose = (purpose, portServiceListItems) => {
  const purposeFiltered = portServiceListItems?.filter((item) => item.purpose === purpose || item.purpose === null || item.purpose === "") || [];
  const duplicatedServices = purposeFiltered.filter((item, _index, arr) => {
    const firstIndex = arr.findIndex((i) => i.service === item.service);
    let lastIndex = -1;
    for (let i = arr.length - 1; i >= 0; i--) {
      if (arr[i].service === item.service) {
        lastIndex = i;
        break;
      }
    }
  ...
  const exactPurposeDuplicates = duplicatedServices.filter((item) => item.purpose === purpose);
  const nonDuplicateServices = purposeFiltered.filter((item) => !duplicatedServices.some((d) => d.service === item.service));
  const finalServiceList = [
    ...nonDuplicateServices,
    ...exactPurposeDuplicates
  ];
  return finalServiceList.map((item) => __spreadValues({}, item));
};
var getMainServiceSerialNumber = (currentIndex, datasource) => {
  if (!datasource || datasource?.length === 0) {
    return 0;
  }
  let mainServiceCount = 0;
  for (let i = 0; i <= currentIndex; i++) {
    if (datasource[i] && !datasource[i].get("isSubService")?.value) {
      mainServiceCount++;
    }
  }
  return mainServiceCount;
};
var formatServices = (rawItems) => {
  return rawItems.map((raw) => {
    const item = new PA_Item();
    item.SNO = raw.SNO;
    item.code = raw.code;
    item.total = raw.total;
    item.service = raw.service;
    item.purpose = raw.purpose;
    item.pa_remark = raw.pa_remark;
    item.meraki_feedback = raw.meraki_feedback;
    item.meraki_remark_client = raw.meraki_remark_client;
    item.client_comment = raw.client_comment;
    item.client_option = raw.client_option;
    item.info_msg = raw.info_msg;
    item.negotiate = raw.negotiate;
    item.agreed = raw.agreed;
    item.display_to_client = raw.display_to_client;
    item.subService = (raw.subService || []).map((s) => {
      const sub = new SubService();
      sub.name = s.name;
      sub.purpose = s.purpose;
      sub.basic_value = s.basic_value;
      sub.hide = s.hide;
      sub.unique_key = s.unique_key;
      sub.calculated_basic_value = s.calculated_basic_value;
      sub.movement = s.movement;
      sub.tariff_percent = s.tariff_percent;
      sub.formula_result = s.formula_result;
      sub.optional = s.optional;
      sub.operational_flag = s.operational_flag;
      sub.sub_total = s.sub_total;
      sub.formula_inputs = s.formula_inputs;
      return sub;
    });
    item.total = raw.total !== null && raw.total !== void 0 ? String(raw.total) : "";
    return item;
  });
};
var restrictDecimal = (event, decimalLimit) => {
...
var getCurrencyFromCountry = (countryList, countryId) => {
  const country = countryList.find((c) => c.country_id === countryId);
  const currency = country?.currency?.toString();
  return currency.includes(",") ? currency.split(",")[0].trim() : currency;
};
var _filterCurrency = (currencyList, value) => {
  const filterValue = value?.toLowerCase();
  return currencyList.filter((currency) => currency.toLowerCase().includes(filterValue));
};
var removeAddedFieldsAndControls = (pdaCreateForm, addedFields, fields2) => {
  addedFields.forEach((added) => {
    if (pdaCreateForm.contains(added.controlName)) {
      pdaCreateForm.removeControl(added.controlName);
    }
  });
  fields2.splice(0, fields2.length, ...fields2.filter((field) => !addedFields.some((added) => added.controlName === field.value)));
};
var onTotalFocus = (row, type) => {
  const control = type ? row.get(type) : row.get("total");
  const value = control?.value;
  row.get("previousTotalValue")?.setValue(value, { emitEvent: false });
  if (Number(value) === 0) {
    control?.setValue(null, { emitEvent: false });
  }
};
var onTotalBlur = (row, type) => {
  const control = type ? row.get(type) : row.get("total");
  if (!control)
    return;
  const value = control.value;
  const previousValue = row.get("previousTotalValue")?.value;
  if (value === "" || value === null || value === void 0 || value === "undefined") {
    control.setValue(previousValue ?? null, { emitEvent: false });
  }
};
var getAdditionalPropertiesObjectFromForm = (addedFields, formGroup, fields2) => {
  const additionalPropertiesArray = [];
  const dateFields = fields2.filter((field) => field.type === "date").map((field) => field.name);
  const processedFields = /* @__PURE__ */ new Set();
  addedFields.forEach(({ fieldName, controlName, is_mandatory, data_type }) => {
    if (processedFields.has(fieldName)) {
      return;
    }
    processedFields.add(fieldName);
    let value = formGroup.get(controlName)?.value ?? null;
    ...
    additionalPropertiesArray.push({
      ...
      is_mandatory: is_mandatory || "N"
    });
  });
  return additionalPropertiesArray;
};
...
//# sourceMappingURL=chunk-4B5JIWQW.js.map
