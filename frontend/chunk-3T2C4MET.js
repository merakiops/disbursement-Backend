...
var LoaderService = class _LoaderService {
  ...
  _dialogLoading = signal(false);
  loading = this._loading.asReadonly();
  dialogLoading = this._dialogLoading.asReadonly();
  show() {
  ...
  showDialogLoader() {
    this._dialogLoading.set(true);
  }
  hideDialogLoader() {
    this._dialogLoading.set(false);
  }
...
//# sourceMappingURL=chunk-3T2C4MET.js.map
