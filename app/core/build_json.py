...
def build_disbursement_json(disbursement_seq:int,vsl_id:int,client_id:int,portagent_id:int,port_id:int,country_id:int,purpose_id,cargo_id:int,services: List[Dict],vessel_stay,ETA,ETD,voyage,pda_custom_calculation,pda_currency_from,pda_currency_to,ROE,db:Session):
    disbursement_data = OrderedDict({
        ...
        "etd": str(ETD)[:10],
        "pda_roe": ROE,
        "pda_currency_to":pda_currency_to,
        "pda_currency_from":pda_currency_from,
        "pda_custom_calculation":pda_custom_calculation,
