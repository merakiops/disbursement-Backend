...
class PDAServiceImpl(PDAService):
    ...
    def initiate_client_disbursement(self, user: str, request_data: Any, background_tasks: BackgroundTasks, db: Session):
        ...
        res = TxnClientDisbursementRequestResponseDTO(
            ...
            interface_unique_ref=request_data.interface_unique_ref,
            previous_port=request_data.previous_port,
            next_port=request_data.next_port,
            preferences=request_data.preferences,
            max_port_call=request_data.max_port_call,
            charterer_time_bar=request_data.charterer_time_bar,
            legal_entity_id=request_data.legal_entity_id,
            trading_company_id=request_data.trading_company_id,
            da_request_type=request_data.da_request_type,
